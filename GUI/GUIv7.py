...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.editcero_1.textChanged.connect(MainWindow.editCero_1) # type: ignore
        self.editpolo_1.textChanged.connect(MainWindow.editPolo_1) # type: ignore
        self.editganancia_1.textChanged.connect(MainWindow.editGan_1) # type: ignore
        self.entrytype_1.activated['int'].connect(MainWindow.changeEntryType_1) # type: ignore
        self.editamplitud_1.textChanged.connect(MainWindow.editAmp_1) # type: ignore
        self.editfrecuencia_1.textChanged.connect(MainWindow.editFrec_1) # type: ignore
        self.filtertype_2.activated['int'].connect(MainWindow.changeEntryType_1) # type: ignore
        self.editw0_2.textChanged.connect(MainWindow.editw0_2) # type: ignore
        self.editxi_2.textChanged.connect(MainWindow.editxi_2) # type: ignore
        self.editganancia_2.textChanged.connect(MainWindow.editGan_2) # type: ignore
        self.entrytype_2.activated['int'].connect(MainWindow.changeFilterType_2) # type: ignore
        self.editamplitud_2.textChanged.connect(MainWindow.editAmp_2) # type: ignore
        self.editfrecuencia_2.textChanged.connect(MainWindow.editFrec_2) # type: ignore
        self.edit_r.textChanged.connect(MainWindow.editRes) # type: ignore
        self.edit_l.textChanged.connect(MainWindow.editInd) # type: ignore
        self.editamplitud_rlc.textChanged.connect(MainWindow.editAmp_rlc) # type: ignore
        self.editfrecuencia_rlc.textChanged.connect(MainWindow.editFrec_rlc) # type: ignore
        ...
        self.edit_c.textChanged.connect(MainWindow.editCap) # type: ignore
